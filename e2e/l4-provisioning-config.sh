...
log "running provision/45-launcher-config.sh (LAUNCHER_CONFIG_KEY=kvaesitso-fork)"
(cd "$GOS_REPO" && LAUNCHER_CONFIG_KEY=kvaesitso-fork ADB_SERIAL="$SERIAL" bash provision/45-launcher-config.sh) \
